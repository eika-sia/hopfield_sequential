...
- Exp07 exact_pair nearest test string accuracy: 0.763
- Exp07 exact_pair nearest length-generalization accuracy: 0.794
- Exp07 exact_pair nearest state-tracking accuracy: 0.688
- Exp07 exact_pair Hopfield dense test string accuracy: 1.000
- Exp07 exact_pair Hopfield dense length-generalization accuracy: 1.000
- Exp07 exact_pair Hopfield dense state-tracking accuracy: 1.000
- Exp07 hashed_pair nearest dense test accuracy by hidden_dim: 32.000=0.825, 128.000=0.959
- Exp07 exact_pair nearest sparse_topk autonomous transition accuracy at write_fraction=0.30 random_noise: 0.998
- Exp07 exact_pair nearest sparse_topk autonomous transition accuracy at write_fraction=0.50 random_noise: 1.000
- Exp07 exact_pair nearest sparse_topk autonomous transition accuracy at write_fraction=0.50 keep_current: 0.432
- Exp07 exact_pair nearest transition coverage: 0.662
- Exp07 exact_pair nearest incomplete-coverage rows: 35
- Exp07 exact_pair nearest incomplete-coverage mean test accuracy: 0.525
- Exp07 seen/unseen structured transition accuracy: seen=1.000, unseen=0.276
- Exp07 first masked top-k reaching 0.95: 5.000
- Exp07 first masked top-k reaching 0.99: 8.000
