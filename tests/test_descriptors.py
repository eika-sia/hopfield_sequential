...
def test_payload_without_descriptor_errors() -> None:
...
def test_store_payload_stores() -> None:
...
def test_compare_same_payload_after_store_is_true() -> None:
...
def test_compare_different_payload_after_store_is_false() -> None:
...
def test_same_payload_with_store_vs_compare_has_different_trajectory() -> None:
    ...
    compare_states = compare_machine.run_sequence(
        [("descriptor", COMPARE), ("payload", p1)]
    )
